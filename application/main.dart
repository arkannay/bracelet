...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: const Text('AILED Demo Application')),
        body: Center(
          ...
          SizedBox(height: 20.0),
          button(() => ble.sendData(0x01), 'Toggle music mode'),
        ])));
  }

  Widget button(func, text) {
    return ElevatedButton(
        child: Text(text, style: TextStyle(fontSize: 20)), onPressed: func);
  }
}
